...
! function (t) {
        ...
        switch (a) {
            ...
            case v.l:
                return function (t, e) {
                    ...
                    switch (e) {
                        case v.i:
                            var i = [B(k, t), B(M, t), B(P, t)];
                            return r(i);
                        case v.k:
                            var o = [B(C, t), B(L, t), B(R, t)];
                            return r(o);
                        case v.j:
                            var a = [B(D, t), B(V, t), B(z, t)];
                            return r(a);
                        case v.l:
                            var u = [B(N, t), B($, t)];
                            return {
        ...
        if (n) return function (t, e) {
            var n = t.element,
                ...
                c = function (t, e, n) {
                    ...
                    switch (r) {
                        case v.i:
                            return void 0 !== l && (h = q(h, k, y.B, l + a)), void 0 !== d && (h = q(h, M, y.C, d + c)), void 0 !== p && (h = q(h, P, y.D, p + f)), h;
                        case v.k:
                            return void 0 !== l && (h = q(h, C, y.u, l + a)), void 0 !== d && (h = q(h, L, y.v, d + c)), void 0 !== p && (h = q(h, R, y.w, p + f)), h;
                        case v.j:
                            return void 0 !== l && (h = q(h, D, y.r, l + a)), void 0 !== d && (h = q(h, V, y.s, d + c)), void 0 !== p && (h = q(h, z, y.t, p + f)), h;
                        case v.l:
                            return void 0 !== l && (h = q(h, N, y.y, l + a)), void 0 !== d && (h = q(h, $, y.z, d + c)), h;
                        default:
                            return h
                    }
                }(u, i, r);
    ...
    function I(t) {
        ...
        var S = u()(n, "action.config.affectedElements", {})[w || x] || {},
            ...
            M = void 0,
            P = n && c(E(n.target));
        if (A ? (T = S.limitAffectedElements, k = P, M = c(S)) : k = M = c({
                id: w,
                selector: x,
                selectorGuids: _
            }), n && j) {
    ...
    window.tram = function (t) {
        ...
        if (M.transition) {
            var P = M.timing.dom;
            if (S.style[P] = l["ease-in-back"][0], !S.style[P])
        ...
        n ? U({
            ...
            y()(n, function (t) {
                if (!t.continuous) {
                    var n = t.actionListId,
                        r = t.verbose;
                    Q(t, e), r && e.dispatch(Object(E.actionListPlaybackChanged)({
                        actionListId: n,
                        isPlaying: !1
                    }))
                }
    ...
    function U(t) {
        ...
        y()(c, function (t) {
            ...
            if (t.actionListId === o && t.eventId === n && u) {
                ...
                Q(t, e), t.verbose && e.dispatch(Object(E.actionListPlaybackChanged)({
                    actionListId: o,
                    isPlaying: !1
                }))
            }
    ...
    function Q(t, e) {
        Y(document.body, "ix2-animation-stopping", t.id), Object(O.a)(t, I), e.dispatch(Object(E.instanceRemoved)(t.id))
    }
    ...
    n(86), n(88), n(238), n(239), t.exports = n(240)
}, function (t, e, n) {
    var r = n(5);
    ...
    var m, b, w, x = function (t) {
        ...
        P = (m = void 0 !== window.pageXOffset, b = "CSS1Compat" === document.compatMode ? document.documentElement : document.body, function () {
            return {
    ...
    e.a = (g(r = {}, p.z, V()), g(r, p.A, z()), g(r, p.d, V()), g(r, p.c, z()), g(r, p.p, V(!1)), g(r, p.o, z(!1)), g(r, p.B, V()), g(r, p.C, z()), g(r, p.f, {
    ...
    "events": {
        "e": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5b1e9a35329968623b2b86b2|48854942-1d18-93a6-cb21-02922c0bb651"
            },
            "config": [{
        ...
        "e-2": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5b1e9a35329968623b2b86b2|b1df903d-c403-1fd6-2c62-f4489f9640ec"
            },
            "config": [{
        ...
        "e-3": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5b1e9a35329968623b2b86b2|538411e0-8328-b857-4903-587629e16555"
            },
            "config": [{
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|ec77f0ac-a61b-3948-6ddd-384d3cc59c6a"
                            },
                            "value": 0,
                            "unit": ""
                        }
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|b3cc935c-3cd0-9ccf-9c4c-191b87bd4454"
                            },
                            "yValue": 400,
                            "xUnit": "PX",
                            "yUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "5b1e9a35329968623b2b86b2|68064c21-e229-cc2a-c9a9-6d754ea41c4a"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "5b1e9a35329968623b2b86b2|7a809bd9-6543-e6e7-22d6-47a8687a2031"
                        }
                    }
                }]
            }],
            "createdOn": 1525085339218,
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|b1df903d-c403-1fd6-2c62-f4489f9640ed"
                            },
                            "value": 0,
                            "unit": ""
                        }
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|b1df903d-c403-1fd6-2c62-f4489f9640ee"
                            },
                            "yValue": 400,
                            "xUnit": "PX",
                            "yUnit": "PX",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|538411e0-8328-b857-4903-587629e16556"
                            },
                            "value": 0,
                            "unit": ""
                        }
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5b1e9a35329968623b2b86b2|538411e0-8328-b857-4903-587629e16557"
                            },
                            "yValue": 400,
                            "xUnit": "PX",
                            "yUnit": "PX",
